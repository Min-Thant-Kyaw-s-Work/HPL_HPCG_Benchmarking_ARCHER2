#!/bin/bash
#SBATCH --job-name=HPCG_2nodes_HYBRID
#SBATCH --nodes=2
...
RESULTS_DIR="/work/ta210/ta210/ta210kyaw2/ciuk2025/green_hpc_challenge/results/hpcg_2nodes_hybrid_$(date +%Y%m%d_%H%M%S)"
mkdir -p ${RESULTS_DIR}

# New problem size for 2 nodes
cat > hpcg.dat << EOF
