#!/bin/bash
#SBATCH --job-name=HPCG_2nodes_HYBRID_32x4
#SBATCH --nodes=2
...
RESULTS_DIR="/work/ta210/ta210/ta210kyaw2/ciuk2025/green_hpc_challenge/results/hpcg_2nodes_hybrid_32x4_$(date +%Y%m%d_%H%M%S)"
mkdir -p ${RESULTS_DIR}

# Problem size for 2 nodes
cat > hpcg.dat << EOF
