#!/bin/bash
#SBATCH --job-name=HPCG_1node_HYBRID
#SBATCH --nodes=1
...
RESULTS_DIR="/work/ta210/ta210/ta210kyaw2/ciuk2025/green_hpc_challenge/results/hpcg_1node_hybrid_$(date +%Y%m%d_%H%M%S)"
mkdir -p ${RESULTS_DIR}

# New problem size for 1 node
cat > hpcg.dat << EOF
