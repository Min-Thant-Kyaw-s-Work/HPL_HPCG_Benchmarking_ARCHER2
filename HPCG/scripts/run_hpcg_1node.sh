...
RESULTS_DIR="/work/ta210/ta210/ta210kyaw2/ciuk2025/green_hpc_challenge/results/hpcg_1node_$(date +%Y%m%d_%H%M%S)"
mkdir -p ${RESULTS_DIR}

# Use dimensions divisible by 8 for better coarsening
cat > hpcg.dat << EOF
cat > hpcg.dat << EOF
