...
RESULTS_DIR="/work/ta210/ta210/ta210kyaw2/ciuk2025/green_hpc_challenge/results/hpcg_4nodes_$(date +%Y%m%d_%H%M%S)"
mkdir -p ${RESULTS_DIR}

# Adjusted dimensions for 512 MPI processes
cat > hpcg.dat << EOF
